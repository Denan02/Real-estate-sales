const PoziviAjax = (() => {
    ...
    function impl_getNekretnina(nekretnina_id, fnCallback) {
        ...
        ajax.open("GET", "http://localhost:3000/nekretnina/"+encodeURIComponent(nekretnina_id), true);
        ajax.send();
    }
    function impl_getNextUpiti(nekretnina_id, page, fnCallback) {
        ...
        ajax.open("GET", "http://localhost:3000/next/upiti/nekretnina"+encodeURIComponent(nekretnina_id)+"?page="+encodeURIComponent(page), true);
        ajax.send();
    }
